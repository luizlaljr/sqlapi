...
const query = `SELECT users.id, users.antique, maxPromotions.last_promotion, posts.name as post, users.name, users.condition,  users.date_condition, users.modulus, users.prevision, users.document, users.operationality, users.activity, users.project, users.sex, posts.factor, posts.wage 
FROM users  
...
GROUP BY users.id, post, users.name, users.antique, maxPromotions.last_promotion, users.condition, users.date_condition, users.modulus, users.prevision, users.document, users.operationality, users.activity, users.project, users.sex, posts.factor, posts.wage
ORDER BY antique`;
